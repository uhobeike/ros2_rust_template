...
async fn main() -> Result<(), DynError> {
  ...
  let subscriber1 = node.create_subscriber::<std_msgs::msg::String>("multi_thread_pubsub_1", None)?;
  let subscriber2 = node.create_subscriber::<std_msgs::msg::String>("multi_thread_pubsub_2", None)?;
